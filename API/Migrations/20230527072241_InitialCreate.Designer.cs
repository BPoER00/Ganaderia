...
namespace API.Migrations
{
    ...
    [Migration("20230527072241_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.CORRAL", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Models.RANGO_DE_PESO", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Models.ANIMAL", b =>
                {
                    b.HasOne("API.Models.CORRAL", "CORRAL")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Models.CORRAL", b =>
                {
                    ...
                    b.HasOne("API.Models.RANGO_DE_PESO", "RANGO")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Models.FINCA", b =>
                {
                    b.HasOne("API.Models.DIRECCION", "DIRECCION")
                        .WithMany()
