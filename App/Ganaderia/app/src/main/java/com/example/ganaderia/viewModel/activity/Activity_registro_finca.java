...
public class Activity_registro_finca extends AppCompatActivity {
    ...
    {
        this.btn_volver = findViewById(R.id.btn_img_volver_fincas);
        this.btn_volver.setOnClickListener(v -> volverMenu());
    }

    private void volverMenu()
    {
        Intent intent = new Intent(Activity_registro_finca.this, MainActivity.class);
