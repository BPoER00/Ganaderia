...
namespace Ganaderia.Controllers
{
    ...
    public class RazasController : ControllerBase
    {
        ...
        public RazasController(ConexionContext _db)
        {
        ...
        public async Task<Reply> Post(RAZA raza)
        {
            try
            {
                ...
                var responseAction = await this.db.Guardar(raza);
        ...
        [HttpPut("{id}")]
        public async Task<Reply> Put(int? id, RAZA raza)
        {
            try
            {
                if(!ModelState.IsValid)
                ...
                var responseAction = await this.db.Actualizar(id, raza);
